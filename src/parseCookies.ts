...
export function parseCookies(ctx: NextContext, options?: CookieParseOptions): Record<string, string>;
export function parseCookies(options?: CookieParseOptions): Record<string, string>;
